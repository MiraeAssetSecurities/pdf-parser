...
- **IBM 레이아웃**: IBM LayoutPredictor 기반 대체 OCR 경로 지원 (`ibm_converter.py`)
...
├── api.service.example           # systemd API 서비스 예시
├── jupyter.service.example       # systemd JupyterLab 서비스 예시
├── imgs/                         # README 이미지
